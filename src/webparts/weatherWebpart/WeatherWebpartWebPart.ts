...
export default class WeatherWebpartWebPart extends BaseClientSideWebPart<IWeatherWebpartWebPartProps> {
  ...
  public render(): void {
    ...
    // console.log(this.context.httpClient);
    const element: React.ReactElement<IWeatherWebpartProps> =
      React.createElement(WeatherWebpart, {
  ...
  // here im starting to write logic to pull data from the web api
